...
onEvent('ftbquests.custom_reward.304CCC9B3B75EE88', e => { 
  ...
  e.server.runCommandSilent(`/title ${e.player.name} title {"text":"恭喜！！！","bold":true,"italic":true,"color":"#9A52FF"}`)
  e.server.runCommandSilent(`/title ${e.player.name} subtitle ["",{"text":"欢迎来到 ","bold":true,"italic":true},{"text":"第一纪元","bold":true,"italic":true,"color":"#9A52FF"},{"text":"！","bold":true,"italic":true}]`)
...
onEvent('ftbquests.custom_reward.0C22A7876B4BAC9C', e => {
  ...
  e.server.runCommandSilent(`/title ${e.player.name} times 20 100 20`)
  e.server.runCommandSilent(`/title ${e.player.name} title {"text":"恭喜！！！","bold":true,"italic":true,"color":"#9A52FF"}`)
  e.server.runCommandSilent(`/title ${e.player.name} subtitle ["",{"text":"欢迎来到 ","bold":true,"italic":true},{"text":"第二纪元","bold":true,"italic":true,"color":"#9A52FF"},{"text":"！","bold":true,"italic":true}]`)
  e.server.runCommandSilent(`/playsound minecraft:ui.toast.challenge_complete master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 1`)
  e.server.runCommandSilent(`/playsound minecraft:entity.generic.explode master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 2`)
  e.server.runCommandSilent(`/particle minecraft:firework ${e.player.x} ${e.player.y} ${e.player.z} 8 8 8 1 5000 normal`)
})
...
onEvent('ftbquests.custom_reward.737ECE941245B6C3', e => {
  ...
  e.server.runCommandSilent(`/title ${e.player.name} times 20 100 20`)
  e.server.runCommandSilent(`/title ${e.player.name} title {"text":"恭喜！！！","bold":true,"italic":true,"color":"#9A52FF"}`)
  e.server.runCommandSilent(`/title ${e.player.name} subtitle ["",{"text":"欢迎来到 ","bold":true,"italic":true},{"text":"第三纪元","bold":true,"italic":true,"color":"#9A52FF"},{"text":"！","bold":true,"italic":true}]`)
  e.server.runCommandSilent(`/playsound minecraft:ui.toast.challenge_complete master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 1`)
  e.server.runCommandSilent(`/playsound minecraft:entity.generic.explode master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 2`)
  e.server.runCommandSilent(`/particle minecraft:firework ${e.player.x} ${e.player.y} ${e.player.z} 8 8 8 1 5000 normal`)
})
...
onEvent('ftbquests.custom_reward.791A03C346152ABF', e => {
  ...
  e.server.runCommandSilent(`/title ${e.player.name} times 20 100 20`)
  e.server.runCommandSilent(`/title ${e.player.name} title {"text":"恭喜！！！","bold":true,"italic":true,"color":"#9A52FF"}`)
  e.server.runCommandSilent(`/title ${e.player.name} subtitle ["",{"text":"欢迎来到 ","bold":true,"italic":true},{"text":"第四纪元","bold":true,"italic":true,"color":"#9A52FF"},{"text":"！","bold":true,"italic":true}]`)
  e.server.runCommandSilent(`/playsound minecraft:ui.toast.challenge_complete master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 1`)
  e.server.runCommandSilent(`/playsound minecraft:entity.generic.explode master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 2`)
  e.server.runCommandSilent(`/particle minecraft:firework ${e.player.x} ${e.player.y} ${e.player.z} 8 8 8 1 5000 normal`)
})
...
onEvent('ftbquests.custom_reward.12B8B9C6FC5AD648', e => {
  ...
  e.server.runCommandSilent(`/title ${e.player.name} times 20 100 20`)
  e.server.runCommandSilent(`/title ${e.player.name} title {"text":"恭喜！！！","bold":true,"italic":true,"color":"#9A52FF"}`)
  e.server.runCommandSilent(`/title ${e.player.name} subtitle ["",{"text":"欢迎来到 ","bold":true,"italic":true},{"text":"游戏终局","bold":true,"italic":true,"color":"#9A52FF"},{"text":"！","bold":true,"italic":true}]`)
  e.server.runCommandSilent(`/playsound minecraft:ui.toast.challenge_complete master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 1`)
  e.server.runCommandSilent(`/playsound minecraft:entity.generic.explode master ${e.player.name} ${e.player.x} ${e.player.y} ${e.player.z} 10 2`)
  e.server.runCommandSilent(`/particle minecraft:firework ${e.player.x} ${e.player.y} ${e.player.z} 8 8 8 1 5000 normal`)
})